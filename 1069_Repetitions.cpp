...
// Solution from here
// *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
ll largest_substring(const std::string& s)
{
    ll N = s.size();
    ll count = 1;
    ll maxcount = 0;
...
TEST_CASE("Counts done", "[counts]"){
    REQUIRE(largest_substring("HHHHAAAA") == 4);
    REQUIRE(largest_substring("HHHHAAAAA") == 5);
    REQUIRE(largest_substring("AHAHAHAHAATTTTTTA") == 6);
    REQUIRE(largest_substring("A") == 1);
    REQUIRE(largest_substring("AT") == 1);
    REQUIRE(largest_substring("ATA") == 1);
    REQUIRE(largest_substring("ATAA") == 2);
    REQUIRE(largest_substring("AATA") == 2);
    REQUIRE(largest_substring("ATTA") == 2);
    ...
    BENCHMARK("largest substring 200") {
            return largest_substring(op);
        };
